...
public class VeiculoController {
  ...
  @PostMapping public Veiculo criar(@RequestBody Veiculo v){ return service.criar(v); }
  ...
  @GetMapping("/{id}") public Veiculo buscar(@PathVariable Long id){ return service.buscar(id); }
