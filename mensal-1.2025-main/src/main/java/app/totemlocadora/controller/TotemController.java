...
public class TotemController {
  ...
  @PostMapping 
  public Totem criar(@RequestBody Totem t){ return service.criar(t); }

  @PutMapping("/{id}") 
  public Totem atualizar(@PathVariable Long id, @RequestBody Totem t){ return service.atualizar(id,t); }

  @DeleteMapping("/{id}") 
  public void deletar(@PathVariable Long id){ service.deletar(id); }

  @GetMapping("/{id}") 
  public Totem buscar(@PathVariable Long id){ return service.buscar(id); }
